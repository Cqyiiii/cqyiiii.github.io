...
<div class="academic-homepage">
  <section class="profile-hero" aria-labelledby="profile-name">
    <div class="profile-hero__content">
      ...
      <div class="profile-actions" aria-label="Profile links">
        ...
        <a class="profile-action" href="https://github.com/Cqyiiii">GitHub</a>
        <a class="profile-action" href="/cv/">Curriculum vitae</a>
      </div>
    ...
    <figure class="profile-hero__portrait">
      <img src="/profile2.jpg" alt="Qianyi Chen at NeurIPS">
    </figure>
  </section>
  ...
  <section class="academic-section research-section" id="research" aria-labelledby="research-heading">
    <div class="section-heading">
      ...
      <p class="research-goal" id="research-heading">My goal is to build effective, scalable, sample-efficient, and easy-to-implement methodology for complex systems.</p>
    </div>
  ...
  <section class="academic-section service-section" id="service" aria-labelledby="service-heading">
    <div class="section-heading">
      <p class="section-kicker">Academic community</p>
      <h2 id="service-heading">Service, teaching &amp; experience</h2>
    </div>
  ...
  <section class="contact-band" id="contact" aria-labelledby="contact-heading">
    ...
    <h2 id="contact-heading">Interested in research conversations.</h2>
    <p class="contact-email">cqy22 <span>[at]</span> mails <span>[dot]</span> tsinghua <span>[dot]</span> edu <span>[dot]</span> cn</p>
  </section>
</div>
